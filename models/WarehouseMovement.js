...
const schema = new mongoose.Schema({
  ...
  type: { type: String, enum: ["opening", "manual-adjustment", "reserve", "release", "project-consumption", "project-adjustment"], required: true },
  actorUserId: { type: mongoose.Schema.Types.ObjectId, required: true }, reason: { type: String, default: "" }, createdAt: { type: Date, default: Date.now },
});
